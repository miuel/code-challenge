...
const ArticlePage: React.FC<ArticlePageProps> = ({ params }) => {
    ...
    return (
        <main className="min-h-screen w-screen p-4">
            <div className='w-screen sm:w-[130vw] h-48 sm:h-80 bg-blue-500 rotate-12 absolute top-0'></div>
            <div className='w-screen sm:w-[130vw] h-48 sm:h-80 bg-red-500 rotate-45 absolute z-0 top-0'></div>
